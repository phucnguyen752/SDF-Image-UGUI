...
To keep this version, use `https://github.com/phucnguyen752/sdf-image.git#0.4.0` instead. Updating a pinned tag does not switch to a newer release tag.
...
Sprite outline, shadow, glow, nine-slice and masking examples:

![SDF Image sprite demo rendered in Unity URP](Assets/SDFImage/Documentation~/preview.png)
